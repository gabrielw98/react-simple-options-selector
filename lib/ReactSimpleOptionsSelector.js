...
var OptionContainer = _styledComponents2['default'].div(_templateObject3, function (props) {
	var margin_padding = '';
	margin_padding += props.selected ? "box-shadow: 10px 10px 5px grey;" : null;
...
var Button = _styledComponents2['default'].input(_templateObject7, function (props) {
	...
	return props.selected ? props.selected_text_color : "white";
}, function (props) {
	return props.selected ? "#ffffff00" : "#ffffff00";
}, function (props) {
	var margin_padding = props.selected ? "box-shadow: 1px 5px 5px lightgrey;" : null;
	return (0, _styledComponents.css)(_templateObject4, margin_padding);
});
